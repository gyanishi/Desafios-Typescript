...
var apiKey = '80c3c68505b6fbfca98d2fd9482695b3';
...
function preencherSenha() {
  let passwordAux = document.getElementById('senha') as HTMLInputElement;
  password = passwordAux.value;
  validateLoginButton();
}

function preencherLogin() {
  let usernameAux = document.getElementById('login') as HTMLInputElement;
  username =  usernameAux.value;
  validateLoginButton();
}

function preencherApi() {
  let apiKeyAux = document.getElementById('api-key') as HTMLInputElement;
  apiKey = apiKeyAux.value;
  validateLoginButton();
}
